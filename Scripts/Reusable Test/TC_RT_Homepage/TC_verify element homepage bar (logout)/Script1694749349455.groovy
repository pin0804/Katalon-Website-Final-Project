...
WebUI.verifyElementVisible(findTestObject('Homepage/Menu Bar/btn_OUR PRODUCTS'))

WebUI.verifyElementVisible(findTestObject('Homepage/Menu Bar/btn_SPECIAL OFFER'))

WebUI.verifyElementVisible(findTestObject('Homepage/Menu Bar/btn_POPULAR ITEMS'))

WebUI.verifyElementVisible(findTestObject('Homepage/Menu Bar/btn_CONTACT US'))
